...
export default function LaCeSaFiiAtent() {
  return (
    <>
      <Helmet>
        <title>La ce să fii atent când cumperi un apartament | Ghid Oltenița</title>
        <meta
          name="description"
          content="Află la ce să fii atent când cumperi un apartament: zonă, acte, costuri, compartimentare și starea locuinței. Ghid util pentru cumpărători."
        />
      </Helmet>
