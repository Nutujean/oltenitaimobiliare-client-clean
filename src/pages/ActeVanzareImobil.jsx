...
export default function ActeVanzareImobil() {
  return (
    <>
      <Helmet>
        <title>Acte necesare pentru vânzarea unui imobil | Ghid Oltenița</title>
        <meta
          name="description"
          content="Vezi ce acte sunt necesare pentru vânzarea unui imobil: act de proprietate, carte funciară, cadastru, certificat fiscal și alte documente utile."
        />
      </Helmet>
